    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        body {
            min-height: 100vh;
            width: 100vw;
            background: #020c1b url('img/login-bg.png') no-repeat center center;
        ...
        .login-wrapper { width: 100%; max-width: 350px; padding: 20px; background: transparent; }
        ...
        @media (max-width: 768px) { body { justify-content: center; padding: 20px; background-size: cover; background-position: center; } .login-wrapper { max-width: 100%; background: transparent; } .login-form { padding: 30px 20px; background: transparent; } }
    </style>
</head>
<body>
