    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        body {
            min-height: 100vh;
            width: 100vw;
            background: #000 url('img/login-bg.jpg') no-repeat center center;
        ...
        .login-wrapper { width: 100%; max-width: 380px; padding: 20px; position: relative; z-index: 10; }
        .login-form {
            background: rgba(0, 20, 40, 0.85);
            padding: 40px 35px;
            border-radius: 20px;
            border: 1px solid rgba(0, 212, 255, 0.2);
            box-shadow: 0 0 40px rgba(0, 212, 255, 0.15), 0 0 80px rgba(0, 0, 0, 0.5);
        ...
        .form-group .input-wrapper i { position: absolute; left: 15px; top: 50%; transform: translateY(-50%); color: rgba(0, 212, 255, 0.7); font-size: 1.1rem; z-index: 2; transition: color 0.3s ease; }
        .form-group input { width: 100%; padding: 15px 15px 15px 45px; background: rgba(255, 255, 255, 0.05); border: 1px solid rgba(0, 212, 255, 0.3); border-radius: 10px; color: #fff; font-size: 1rem; transition: all 0.3s ease; }
        .form-group input::placeholder { color: rgba(255, 255, 255, 0.4); }
        .form-group input:not(:placeholder-shown) { background: rgba(255, 255, 255, 0.95); color: #1a1a2e; border-color: rgba(0, 212, 255, 0.8); }
        .form-group input:focus { background: rgba(255, 255, 255, 0.95); color: #1a1a2e; border-color: #00d4ff; outline: none; box-shadow: 0 0 15px rgba(0, 212, 255, 0.3); }
        ...
        .form-check-input { background: transparent; border: 1px solid rgba(0, 212, 255, 0.4); }
        ...
        .login-title h4 { color: #fff; font-size: 1.1rem; font-weight: 600; margin-bottom: 5px; }
        .login-title p { color: #00d4ff; font-size: 0.85rem; font-style: italic; }
        @media (max-width: 768px) {
            body { justify-content: center; padding: 20px; background-position: center; }
            .login-wrapper { max-width: 100%; }
            .login-form { padding: 30px 25px; background: rgba(0, 20, 40, 0.95); }
        }
    </style>
</head>
<body>
    <div class="login-wrapper">
        <div class="login-form">
            ...
            <div class="login-title">
                ...
                <p>Sisteme erisim icin giris yapin</p>
            </div>
            <?php if ($error): ?>
                <div class="alert">
            ...
            <form method="POST" action="">
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="text" name="username" placeholder="Kullanici adinizi girin" value="<?= e($username) ?>" required autofocus>
                    </div>
                </div>
                <div class="form-group">
                    <label>Sifre</label>
